...
public abstract class RecyclerPresenter{
    ...
    public RecyclerHolder createHolder(ViewGroup parent,int viewType){
        Class<? extends RecyclerHolder> holderClass = mItemProviders.get(viewType);
        try {
            if (holderClass == null) {
    ...
    protected void registViewTemplate(int viewType,Class<? extends RecyclerHolder> holderClass) {
